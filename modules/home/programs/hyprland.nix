{
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
           ...
           monitor = eDP-1, 2256x1504@60, auto, 1.57
           ...
           # Or execute your favorite apps at launch like this:
            ...
            exec-once = hyprpaper
            exec-once = [workspace 2 silent] vesktop --class=vesktop
            exec-once = hypridle
            exec-once = firefox
            exec-once = Bitwarden
           ...
           bind = ,F1, pass, class:^(TeamSpeak 3)$  # Pass f1 to TeamSpeak3.
           bind = ,F4, pass, class:^(vesktop)$  # Pass SHIFT + R  to veskop.
